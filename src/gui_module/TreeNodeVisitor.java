...
public class TreeNodeVisitor implements Visitor {
	...
	public DefaultMutableTreeNode visit(MainClass mainc) {
		...
		node.add(this.visit(mc.st));//STAEMENT
	...
	public DefaultMutableTreeNode visit(MethodDeclaration method) {
		...
		for (int i=0 ; i<m1.varDeclaration.size() ; i++){
			DefaultMutableTreeNode temp = this.visit(m1.varDeclaration.get(i));
			root.add(temp);
		}
		for (int i=0 ; i<m1.stmt.size() ; i++){
			DefaultMutableTreeNode temp = this.visit(m1.stmt.get(i));
			root.add(temp);
		}
		root.add(new DefaultMutableTreeNode(m1.RETURN));
		root.add(this.visit(m1.exp));
	...
	public DefaultMutableTreeNode visit(Parameter params) {
		...
		for(int i=0 ; i<p1.type.size() ; i++){
			root.add(this.visit(p1.type.get(i)));
		}
...
//		frame.getContentPane().add(jScrollPane);
	...
	public DefaultMutableTreeNode visit(Dot_Expression exp) {
		if (exp instanceof Dot_Expression1 ) {
			...
			DefaultMutableTreeNode temp2 = this.visit(list.get(i));
			root.add(temp2);
			if (i != list.size()-1 ) 
				root.add(new DefaultMutableTreeNode(","));
			}
	...
	public DefaultMutableTreeNode visit(Expression_Alpha ea) {
		...
		if (ea instanceof Expression_Alpha1 ){
			...
			root.add(temp);
			root.add(this.visit(alpha1.exp));
			root.add(this.visit(alpha1.exp_alpha)) ;
			return root ;
			...
			root.add(new DefaultMutableTreeNode ("["));
			root.add(this.visit(alpha2.exp));
			root.add(new DefaultMutableTreeNode ("]"));
			root.add(this.visit(alpha2.exp_alpha)) ;
			return root ;
			...
			root.add(new DefaultMutableTreeNode ("."));
			root.add(this.visit(alpha3.exp));
			root.add(this.visit(alpha3.exp_alpha)) ;
			return root ;
		}else {
	...
	public DefaultMutableTreeNode visit(New_Expression newex) {
		...
		if (newex instanceof New_Expression1 ){
			...
			root.add(new DefaultMutableTreeNode("["));
			root.add(this.visit(new_Expression1.exp));
			root.add(new DefaultMutableTreeNode("]")) ;
			return root ;
		}else {
	...
	public DefaultMutableTreeNode visit(Expression exp) {
		...
		if (exp instanceof Expression1 ){
			...
			root.add(this.visit(exp6.exp));
			root.add(this.visit(exp6.exp_alpha));
			return root ;
			...
			root.add(new DefaultMutableTreeNode("!"));
			root.add(this.visit(exp7.exp));
			root.add(this.visit(exp7.exp_alpha));
			return root ;
			...
			root.add(new DefaultMutableTreeNode("("));
			root.add(this.visit(exp8.exp));
			root.add(new DefaultMutableTreeNode(")"));
			root.add(this.visit(exp8.exp_alpha));
			return root ;
	...
	public DefaultMutableTreeNode visit(Identifier_Statement statement) {
		if (statement instanceof Identifier_Statement1 ){
			...
			root.add(new DefaultMutableTreeNode("="));
			root.add(this.visit(identifier_Statement1.exp));
			root.add(new DefaultMutableTreeNode(";"));
			return root ;
			...
			root.add(new DefaultMutableTreeNode("["));
			root.add(this.visit(identifier_Statement2.exp1));
			root.add(new DefaultMutableTreeNode("]"));
			root.add(new DefaultMutableTreeNode("="));
			root.add(this.visit(identifier_Statement2.exp2));
			return root ;
		}
	}
	...
	public DefaultMutableTreeNode visit(Statement st) {
		if (st instanceof Statement1 ){
			...
			for ( int i = 0 ; i < list.size() ; i++ ) {
				root.add(this.visit(list.get(0)));
			}
			root.add(new DefaultMutableTreeNode("}"));
			return root ;
			...
			root.add(new DefaultMutableTreeNode("("));
			root.add(this.visit(st2.exp1));
			root.add(new DefaultMutableTreeNode(")"));
			root.add(this.visit(st2.state1));
			if (st2.state2 != null) {
				root.add(new DefaultMutableTreeNode("else"));
				root.add(this.visit(st2.state2));
			}
			return root ;
			...
			root.add(new DefaultMutableTreeNode("("));
			root.add(this.visit(st3.exp1));
			root.add(new DefaultMutableTreeNode(")"));
			root.add(this.visit(st3.state1));
			return root ;
			...
			root.add(this.visit(st5.identifier_statement1));
			return root ;
